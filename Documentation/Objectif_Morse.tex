...
\begin{titlepage}
    \begin{center}
        ...
        {\sffamily
        \fontsize{32}{10}\selectfont \fontfamily{lmtt}\selectfont Objectif Morse
        }
        \vspace*{1cm}
...
We would like to give special thanks to our friend Lama 
...
The complete code produced is not included in this document. You can download everything needed from our \href{https://github.com/camillejr/objectif_morse}{GitHub repository}.
