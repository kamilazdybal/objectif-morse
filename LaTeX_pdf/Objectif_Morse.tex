...
This is a scheme of how the code was distributed over devices:
...
We will now describe the class elements. We start with the class functions:
...
\verb|morse::outputMorse()| - a public function that 



\verb|morse::outputText()| - a public function that 
