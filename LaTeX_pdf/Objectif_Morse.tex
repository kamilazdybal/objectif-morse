...
First, it is possible that things won't work when you put the cables together. Second, it is possible that the code we produced contains bugs and might cause unexpected behaviours. Third, it is possible that certain favourable conditions arised when we were working on this project, which led to our success and it might take some effort before they reappear again\footnote{it is quite common among computers that the nerby presence of certain objects, or certain position with respect to certain constellations, or certain mysterious words in certain forgotten config files is causing things to work.}.

If you have just said: \textit{"How awesome! I can't wait for that!"}, then I wish you a lot of errors in your life, because you're going to learn a lot from them. You're the right person in the right place.
...
In this subsection we are going to take a closer look how the functions and variables declared inside the \verb|morse| class are defined. This part is for you to better understand how they work, so that perhaps you can point out (and we secretly hope for that) where they could be improved and build much better ones yourself.
...
The C++ "Main" of the broadcasting phase is included in the file \verb|broadcastMain.cpp|. This is where a lot of messing around can be made, because this code is just calling our already preciously prepared pieces. If you don't like our implementation of the user interface in the \textit{Objectif Morse} project, you have a lot of freedom to play with this file.
