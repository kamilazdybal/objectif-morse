...
In order to protect the \textbf{receiving} phase we've decided that we won't make the boundary between the High and Low states touch, therefore making a relatively big separation between what is interpreted as High and Low states. In that case even if the oscillation happens, the measurements inside the blackout zone will be ignored by Arduino.
