...
The second and the most important purpose is to serve as a tutorial for you, if you ever feel like embarking on the same adventure as we did. And it is not a very difficult road to go. Following the document you should be able to accomplish the same mission and maybe even extend it with your own ideas. This journey will increase your knowledge in C++, Linux, Arduino, electronics and, undoubtedly, French language. Either some basic understanding in all of these is requried as a prerequisite, or a strong will to invest time and effort to learn many new things as you go.

This project is aimed for explorers and experimenters for whom it may perhaps seem difficult at first. We have kept the spirit of "learning by doing" because we believe that this is the most effective way to understand the difficult. 
